            ...
            <?php if(Route::has('login')): ?>
                <div class="fixed top-0 right-0 hidden px-6 py-4 sm:block">
                    <?php if(auth()->guard()->check()): ?>
                        <a href="<?php echo e(route(auth()->user()->role)); ?>" class="text-sm text-gray-700 underline dark:text-gray-500">Dashboard</a>
                    <?php else: ?>
...
<?php /**PATH D:\coding\blog\resources\views/welcome.blade.php ENDPATH**/ ?>